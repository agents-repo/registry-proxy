...
| Deck | PDF | Audience |
| --- | --- | --- |
| [proxy-architecture.md](proxy-architecture.md) | [proxy-architecture.pdf](pdf/proxy-architecture.pdf) | Proxy maintainers |
...
| `npm run slides:check` | Fail on source drift, missing/non-PDF artifact, or Chrome rebuild failure |
